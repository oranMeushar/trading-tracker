...
import { ChartWrapper, Header } from './performanceChart.style';


const PerformanceChart = ({title, data, width, height}) => {
    const chartRef = useRef(HighchartsReact.RefObject);
    const {failure, success, categories} = data;
        ...
        tooltip: {
            ...
            formatter: function() {
                ...
                // debugger
                    ...
                    <p><span style="font-weight: bold;">Total Profit: </span>$${this.point.options.totalProfit}</p>
        ...
        plotOptions: {
            column: {
                ...
                dataLabels: {
                    ...
                    formatter: function () {
                        return  `<div style="font-family: Roboto; font-size: 10px;">${this.y} ${this.y === 0 ? '' : this.point.options.status}</div>`;
                    }
                },
            },
        },
